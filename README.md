# Curently working on a Course project with my Team in developing an AI Chatbot in an existing App called "AutoProphet" which is a financing app where users can invest on stocks.
